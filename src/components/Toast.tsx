        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className="pointer-events-auto bg-slate-900/95 text-slate-100 border border-slate-700/80 shadow-2xl rounded-xl p-3.5 flex items-start gap-3 backdrop-blur-md"
            >
